...
export const grade3Math: Star[] = [
  {
    id: 'g3_math_01', subject: 'math', grade: 3, minutes: 12,
    title: 'Warming Up',
    blurb: 'Two-digit adding and taking away, to see where we are starting from.',
    content: { kind: 'generated', count: 14, generator: { type: 'math', skills: ['add-two-digit', 'sub-two-digit'] } },
  },
  {
    id: 'g3_math_02', subject: 'math', grade: 3, minutes: 13,
    title: 'Into the Hundreds',
    blurb: 'Three-digit numbers. Line up the hundreds, tens, and ones in your head.',
    content: { kind: 'generated', count: 12, generator: { type: 'math', skills: ['add-three-digit'] } },
  },
  {
    id: 'g3_math_03', subject: 'math', grade: 3, minutes: 13,
    title: 'Borrowing and Regrouping',
    blurb: 'Subtraction with big numbers. This is the one people find tricky — take your time.',
    content: { kind: 'generated', count: 12, generator: { type: 'math', skills: ['sub-three-digit'] } },
  },
  {
    id: 'g3_math_04', subject: 'math', grade: 3, minutes: 12,
    title: 'Groups of Things',
    blurb: 'Multiplication is just adding the same number over and over, faster.',
    content: { kind: 'generated', count: 14, generator: { type: 'math', skills: ['mult-facts'] } },
  },
  {
    id: 'g3_math_05', subject: 'math', grade: 3, minutes: 12,
    title: 'Sharing Equally',
    blurb: 'Division. The opposite question to multiplication.',
    content: { kind: 'generated', count: 14, generator: { type: 'math', skills: ['div-facts'] } },
  },
  {
    id: 'g3_math_06', subject: 'math', grade: 3, minutes: 13,
    title: 'Times and Share Together',
    blurb: 'Both directions, mixed. Read the sign before you start.',
    content: { kind: 'generated', count: 16, generator: { type: 'math', skills: ['mult-facts', 'div-facts'] } },
  },
  {
    id: 'g3_math_07', subject: 'math', grade: 3, minutes: 13,
    title: 'Bigger Multiplication',
    blurb: 'Two-digit times one-digit. Break the big number apart first.',
    content: { kind: 'generated', count: 12, generator: { type: 'math', skills: ['mult-two-digit'] } },
  },
  {
    id: 'g3_math_08', subject: 'math', grade: 3, minutes: 13,
    title: 'Pieces of a Whole',
    blurb: 'Fractions. Which piece is bigger, and why.',
    content: { kind: 'generated', count: 12, generator: { type: 'math', skills: ['fractions-compare'] } },
  },
  {
    id: 'g3_math_09', subject: 'math', grade: 3, minutes: 13,
    title: 'The Same Amount, Different Names',
    blurb: 'One half and two quarters are the same thing wearing different clothes.',
    content: { kind: 'generated', count: 12, generator: { type: 'math', skills: ['fractions-equivalent'] } },
  },
  {
    id: 'g3_math_10', subject: 'math', grade: 3, minutes: 12,
    title: 'Close Enough',
    blurb: 'Rounding. Knowing roughly is often more useful than knowing exactly.',
    content: { kind: 'generated', count: 12, generator: { type: 'math', skills: ['rounding'] } },
  },
  {
    id: 'g3_math_11', subject: 'math', grade: 3, minutes: 13,
    title: 'Around and Inside',
    blurb: 'Area and perimeter. One is the walk around, one is the space within.',
    content: { kind: 'generated', count: 12, generator: { type: 'math', skills: ['area-perimeter'] } },
  },
  {
    id: 'g3_math_12', subject: 'math', grade: 3, minutes: 13,
    title: 'Watching the Clock',
    blurb: 'Elapsed time. How long from now until then.',
    content: { kind: 'generated', count: 10, generator: { type: 'math', skills: ['elapsed-time'] } },
  },
  {
    id: 'g3_math_13', subject: 'math', grade: 3, minutes: 13,
    title: 'Making Change',
    blurb: 'Money problems. Counting up is usually easier than subtracting.',
    content: { kind: 'generated', count: 12, generator: { type: 'math', skills: ['money'] } },
  },
  {
    id: 'g3_math_14', subject: 'math', grade: 3, minutes: 14,
  ...
  {
    id: 'g3_math_15', subject: 'math', grade: 3, minutes: 14,
    title: 'Harder Stories',
    blurb: 'These take two steps. Do the first one before you look for the second.',
    content: { kind: 'generated', count: 12, generator: { type: 'math', skills: ['word-problem', 'mult-facts', 'div-facts'] } },
  },
  {
    id: 'g3_math_16', subject: 'math', grade: 3, minutes: 14,
    title: 'Fractions and Rounding',
    blurb: 'Two of the trickiest ideas, side by side.',
    content: { kind: 'generated', count: 14, generator: { type: 'math', skills: ['fractions-compare', 'fractions-equivalent', 'rounding'] } },
  },
  {
    id: 'g3_math_17', subject: 'math', grade: 3, minutes: 14,
    title: 'Measure and Time',
    blurb: 'Shapes, clocks, and coins together.',
    content: { kind: 'generated', count: 14, generator: { type: 'math', skills: ['area-perimeter', 'elapsed-time', 'money'] } },
  },
  {
    id: 'g3_math_18', subject: 'math', grade: 3, minutes: 15,
    title: 'The Whole Ladder',
    blurb: 'Everything from this constellation, all mixed together.',
    content: { kind: 'generated', count: 18, generator: { type: 'math', skills: ['add-three-digit', 'sub-three-digit', 'mult-facts', 'div-facts', 'fractions-compare', 'rounding', 'word-problem'] } },
  },
  {
    id: 'g3_math_19', subject: 'math', grade: 3, minutes: 14,
    title: 'Fast and Accurate',
    blurb: 'Facts you should know without stopping to work them out.',
    content: { kind: 'generated', count: 20, generator: { type: 'math', skills: ['mult-facts', 'div-facts'] } },
  },
  {
    id: 'g3_math_20', subject: 'math', grade: 3, minutes: 16,
    title: 'The Counting Crown',
    blurb: 'The final star. Twenty problems, every skill you have. Go carefully.',
    content: { kind: 'generated', count: 20, generator: { type: 'math', skills: ['add-three-digit', 'sub-three-digit', 'mult-two-digit', 'div-facts', 'fractions-equivalent', 'rounding', 'area-perimeter', 'elapsed-time', 'money', 'word-problem'] } },
  },
];
